...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { bank: @credit_card.bank, goals: @credit_card.goals, interest_rate: @credit_card.interest_rate, limit: @credit_card.limit, nickname: @credit_card.nickname, user_id: @credit_card.user_id } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { bank: @credit_card.bank, goals: @credit_card.goals, interest_rate: @credit_card.interest_rate, limit: @credit_card.limit, nickname: @credit_card.nickname, user_id: @credit_card.user_id } }
