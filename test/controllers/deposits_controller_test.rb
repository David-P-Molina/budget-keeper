...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post deposits_url, params: { deposit: { account_id: @deposit.account_id, amount: @deposit.amount, description: @deposit.description, type: @deposit.type, user_id: @deposit.user_id } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { account_id: @deposit.account_id, amount: @deposit.amount, description: @deposit.description, type: @deposit.type, user_id: @deposit.user_id } }
